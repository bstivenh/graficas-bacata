...
class Pidie {
  ...
  countries() {
    return [
      ...
      { id: 'AW', name: 'Aruba', currency_code: 'AWG', currency_name: 'Florin', phone: '+297', language_code: 'hy', language_name: 'Aruba', demonym: 'Aruba' }, 
      ...
      { id: 'CW', name: 'Curazao', currency_code: 'FAN', currency_name: 'Florin', phone: '+5999', language_code: 'ne', language_name: 'Neerlandes', demonym: 'Curazao' }, 
      ...
      { id: 'JP', name: 'Japan', currency_code: 'JPY', currency_name: 'Yen', phone: '+81', language_code: 'ja', language_name: '日本語', demonym: 'Japanese' },
      ...
      { id: 'MX', name: 'Mexico', currency_code: 'MXP', currency_name: 'Peso', phone: '+52', language_code: 'mx', language_name: 'Mexico', demonym: 'Mexico' },
      { id: 'NI', name: 'Nicaragua', currency_code: 'NIC', currency_name: 'Cordoba', phone: '+55', language_code: 'nic', language_name: 'Nicaragua', demonym: 'Nicaragua' },
      { id: 'PA', name: 'Panama', currency_code: 'PAN', currency_name: 'Balboa', phone: '+507', language_code: 'pa', language_name: 'Panama', demonym: 'Panama' },
      { id: 'PY', name: 'Paraguay', currency_code: 'PRY', currency_name: 'Guarani', phone: '+595', language_code: 'py', language_name: 'Paraguay', demonym: 'Paraguay' },
      { id: 'PE', name: 'Peru', currency_code: 'PEN', currency_name: 'Sol', phone: '+51', language_code: 'pe', language_name: 'Peru', demonym: 'Peru' },
      { id: 'PR', name: 'Puerto Rico', currency_code: 'USD', currency_name: 'Dollar', phone: '+1 787', language_code: 'pr', language_name: 'Puerto Rico', demonym: 'Puerto Rico' },
      { id: 'ES', name: 'Spain', currency_code: 'EUR', currency_name: 'Euro', phone: '+34', language_code: 'es', language_name: 'España', demonym: 'España' },
      { id: 'TT', name: 'Trinidad and Tobago', currency_code: 'TTD', currency_name: 'Dollar', phone: '+1 868', language_code: 'nic', language_name: 'Trinidad and Tobago', demonym: 'Trinidad and Tobago' },
      { id: 'US', name: 'United State', currency_code: 'USD', currency_name: 'Dollar', phone: '+1', language_code: 'us', language_name: 'USA', demonym: 'USA' },
      { id: 'GB', name: 'United Kingdom', currency_code: 'GBP', currency_name: 'Libra', phone: '+44', language_code: 'uk', language_name: 'United Kingdom', demonym: 'United Kingdom' },
      { id: 'UY', name: 'Uruguay', currency_code: 'UYU', currency_name: 'Peso', phone: '+598', language_code: 'uy', language_name: 'Uruguay', demonym: 'Uruguay' },
      { id: 'VE', name: 'Venezuela', currency_code: 'VES', currency_name: 'Bolivar', phone: '+58', language_code: 've', language_name: 'Venezuela', demonym: 'Venezuela' },
  ...
  telephoneInput() {
    ...
    Array.prototype.forEach.call(document.querySelectorAll('.pd-telephone-input'), function(elem){
      ...
      var dropdownContent = '';
      dropdownContent += '<div class="pd-telephone-flag"><div class="flag flag-co"></div></div><ul class="pd-telephone-list"></ul>';
